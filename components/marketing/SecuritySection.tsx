  ...
  return (
    <section className="relative overflow-hidden py-24 lg:py-32">
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 10% 50%, rgba(20,184,166,0.07) 0%, transparent 55%), radial-gradient(ellipse at 90% 20%, rgba(124,58,237,0.05) 0%, transparent 55%)',
        }}
      />
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <div
                className="pointer-events-none absolute inset-0 scale-90 animate-glow-pulse rounded-full blur-3xl"
                style={{
                  background:
                    'radial-gradient(circle, rgba(124,58,237,0.2) 0%, rgba(20,184,166,0.1) 60%, transparent 80%)',
                }}
              />
              <div
                className="relative w-[280px] overflow-hidden rounded-[40px]"
                style={{
                  background: 'linear-gradient(145deg, #0F2547, #071628)',
                  border: '1px solid rgba(124,58,237,0.15)',
                  boxShadow: '0 24px 48px rgba(0,0,0,0.5), 0 0 0 1px rgba(124,58,237,0.08)',
                }}
              >
