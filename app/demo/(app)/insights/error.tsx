...
export default function InsightsError({ reset }: Props) {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-5 text-center">
      <p className="mb-6 select-none text-7xl font-black leading-none text-white/[0.05]">!</p>
      <h2 className="mb-2 text-lg font-bold text-white">Insights unavailable</h2>
      <p className="mb-8 max-w-xs text-sm leading-relaxed text-white/55">
        Your spending data could not be loaded. Your transactions are unaffected.
      </p>
      <button
        onClick={reset}
